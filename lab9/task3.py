...
# Загружаем изображения для выбора цвета и инструментов
back_choose = pygame.image.load("Lab9/images/back.png")
red_choose = pygame.image.load("Lab9/images/red.png")
blue_choose = pygame.image.load("Lab9/images/blue.png")
green_choose = pygame.image.load("Lab9/images/green.png")
white_choose = pygame.image.load("Lab9/images/white.png")
yellow_choose = pygame.image.load("Lab9/images/yellow.png")
rect_choose = pygame.image.load("Lab9/images/rect.png")
tria_choose = pygame.image.load("Lab9/images/tria.png")
circle_choose = pygame.image.load("Lab9/images/circle.png")
square_choose = pygame.image.load("Lab9/images/square.png")
eraser = pygame.image.load("Lab9/images/eraser.png")

# Инициализируем переменные
pos, cur, rect = None, None, None
select = RED  # Выбранный цвет по умолчанию
size = 3  # Начальный размер кисти
...
while done:
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONUP:
            ...
            # Обработка нажатия кнопок выбора цвета и инструментов
    ...
    # Отображение выбора цвета и инструментов
